<main class = "container">
    <header class = "row">
        <div class = "mr-3">
            <a type = "button" class=" text-center btn btn-primary" href = "<?=site_url('cliente/painel/perfil#enderecos')?>">Voltar</a>
        </div>
        <h1><?=$titulo?></h1>
    </header>
    <form>
        ...
        <div class = "row justify-content-end">
            <a type="button" class="btn btn-secondary" href = "<?=site_url('cliente/painel/perfil#enderecos')?>">Cancelar</a>
